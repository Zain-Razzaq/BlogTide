...
const LandingPage = () => {
  ...
  return (
    <div className="bg-customColor1 h-screen w-screen flex flex-col justify-center items-center">
      <div className=" h-48 font-josefin relative flex items-end select-none">
        <div className="text-[18rem] text-customColor2 opacity-40  leading-[13rem] absolute top-0">
          Y
        </div>
